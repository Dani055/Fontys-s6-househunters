...
import { getUsersBulk, mapEntityWithCreator } from "service/userService";
            ...
            <div className="border-purple-light p-3 border-2 border rounded-bottom">
              <div className="row">
                <div className="col-auto me-auto">
                  <p className="m-0">
                    Property owner:
                    <Link className="link-dark" to={"/profile/" + 'todo get username'}>
                      <svg
            ...
            {bids && <div className="mb-2 rounded-top shadow-sm">
              {
                ...
                <div className="current-bid-details border-thick-right bg-success text-success bg-opacity-10 p-3">
                  <p>
                    ...
                    <Link className="link-success" to={"/profile/" + bids[0].creator?.username}>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="32"
                        height="32"
